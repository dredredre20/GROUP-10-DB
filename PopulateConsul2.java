...
public class PopulateConsul2 {
    ...
    public PopulateConsul2(String hmo, String user, String pass){
    ...
    public void consultations2(){
       ...
       try {
            ...
            Object[][] diag = {
                    ...
                    { 1021, "Lack of exercise activities", "Mild"},
                    { 1022, "Exposure to sunlight", "Moderate"},
                    { 1023, "Intake of unhealthy food daily", "Moderate"},
                    { 1024, "Explosion of the appendix", "Severe"},
                    { 1025, "Pregnancy routine checkup", "Normal"}
            };
            ...
            Object[][] pres = {
                    ...
                    {  1014, 1021, "500 mg", "Twice a day", "2024-11-22", "2025-11-21", 
                     "Continuous exercise"},
                    {  1010, 1022, "20 mg", "Twice a day", "2024-11-22", "2025-01-22", 
                     "Drink plenty of water"},
                    {  1011, 1023, "50 mcg", "Once daily", "2024-11-22", "2025-11-21",
                     "Also plenty of exercise"},
                    {  1022, 1024, "2.5 mg", "Twice a day", "2024-11-22", "2025-11-21",
                     "Drink after surgery for pain relief"},
                    {  1028, 1025, "2.5 mg", "Twice a day", "2024-11-22", "2025-11-21", 
            ...
            System.out.println("References data loaded");
        }
    }
}
